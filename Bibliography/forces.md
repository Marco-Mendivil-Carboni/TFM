...
where now $d _{ij} = \left\|\bar{r} _i - \bar{r _l} _j\right\|$ and $\bar{r _l}$ are the lbs (lamina binding sites) positions

$$
-\frac{\partial V}{\partial \bar{r} _i} = \sum _{j \neq i} \varepsilon \frac{8}{3 r _c ^{2}} \left( \frac{d _{ij} ^{6}}{r _c ^{6}} - 1\right) (\bar{r} _i - \bar{r _l} _j)
$$
