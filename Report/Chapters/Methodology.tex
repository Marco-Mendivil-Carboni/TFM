...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=2]
        \draw[color1,fill=color1,fill opacity=0.25] (1.2,3.2) circle (0.5); \node[above right,color1] at (1.2,3.2) {1};
        \draw[color1,fill=color1,fill opacity=0.25] (2.8,0.8) circle (0.5); \node[above right,color1] at (2.8,0.8) {1};
        \draw[color1,fill=color1,fill opacity=0.25] (2.5,2.1) circle (0.5); \node[above right,color1] at (2.5,2.1) {1};
        \draw[color1,fill=color1,fill opacity=0.25] (3.1,1.1) circle (0.5); \node[above right,color1] at (3.1,1.1) {1};
