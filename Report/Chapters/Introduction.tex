...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=1.5]
        \draw[black] (+0.0,+0.0) -- (+0.9,+0.1);
        \draw[black] (+0.9,+0.1) -- (+1.2,+0.9);
        \draw[black] (+1.2,+0.9) -- (+1.9,+1.2);
        \draw[black] (+1.9,+1.2) -- (+2.6,+1.2);
        \draw[black] (+2.6,+1.2) -- (+3.2,+0.6);
        \draw[black] (+3.2,+0.6) -- (+3.4,+0.0);
        \draw[black] (+3.4,+0.0) -- (+2.8,-0.4);
        \draw[black] (+2.8,-0.4) -- (+1.9,-0.5);
        \draw[black] (+1.9,-0.5) -- (+1.6,+0.3);
        \draw[black] (+1.6,+0.3) -- (+0.9,+0.7);
        \draw[black] (+0.9,+0.7) -- (+0.3,+1.4);
        \draw[black] (+0.3,+1.4) -- (-0.1,+0.8);
        \draw[black] (-0.1,+0.8) -- (-0.9,+0.6);
        \draw[-latex,color1] (+3.8,+1.6) -- (+2.6,+1.2) node[midway,above]{$\bar{r}_i$};
        \draw[-latex,color1] (+3.8,+1.6) -- (+4.4,+1.0) node[midway,left]{$\bar{b}_i$};
        \draw[latex-latex,color1,dashed] (+2.6,+1.2) -- (+3.2,+0.6) node[midway,left]{$l_i$};
        \draw[color1,dashed] (+2.6,+1.2) -- (+3.3,+1.2);
        \draw[color1] (+3.1,+1.2) arc (0:-45:0.5) node[midway,right]{$\theta_i$};
        \draw[latex-latex,color1,dashed] (+2.6,+1.2) -- (+0.3,+1.4) node[midway,above]{$d_{ij}$};
        \draw[black,fill] (+3.8,+1.6) circle (1pt) node[anchor=south]{$O$};
    \end{tikzpicture}
